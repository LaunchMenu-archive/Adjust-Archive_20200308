...
export declare class ModuleViewClassCreator {
     ...
     */
    static createModuleView<M extends Constructor<any>, S extends object = {}, V extends ExtendsClass<typeof ModuleView, ModuleView<{}, {}, ParameterizedModule, {}>> = ExtendsClass<typeof ModuleView, ModuleView<{}, {}, ParameterizedModule, {}>>>(module: M, state?: S, moduleView?: V): ExtendedModuleViewClass<M, S, V>;
}
/**
