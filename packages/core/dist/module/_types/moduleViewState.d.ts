 ...
 */
export declare type ModuleViewState<S extends ModuleState, C extends SettingsConfig> = S & {
    "~settings": SettingsData<C>;
};
/**
 * A base interface for the react state of the view, with default parameters
 */
export declare type ParameterizedModuleViewState<S extends ModuleState = ModuleState, C extends SettingsConfig = SettingsConfig> = ModuleViewState<S, C>;
