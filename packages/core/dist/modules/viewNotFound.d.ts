...
declare const ViewNotFoundModule_base: import("../module/_types/extendedModule").ExtendedModuleClass<{
    ...
    isStopping: boolean;
    isStopped: boolean;
}, import("../storage/settings/_types/settingsConfig").SettingsConfig<import("../utils/_types/standardTypes").Empty>, import("../module/_types/moduleInterface").ModuleInterface>>>;
/**
