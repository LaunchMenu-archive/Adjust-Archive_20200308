...
class Semver {
     ...
     */
    static create(major = 0, minor = 0, patch = 0, label = "") {
     ...
     */
    static isValid(version, strict = true) {
        if (strict)
            return !!version.match(strictSemverRegex);
        else
