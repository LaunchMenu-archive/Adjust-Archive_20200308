 ...
 */
export declare type SettingInput<V, C extends {}> = ChildModule<{
    /**
...
export declare type SettingInputParent<V> = ParentModule<{
    /**
...
export declare type SettingInputContract<V, C> = {
