 ...
 */
export declare type SettingsPriorityList<C extends SettingsConfig> = {
    [k in keyof C]: C[k] extends ParameterizedSettingDefinition ? SettingPriorityList<C[k]["default"]> : (C[k] extends SettingsConfig ? SettingsData<C[k]> : undefined);
};
/**
 * SettingsPriorityList, but with a default parameter
 */
export declare type ParameterizedSettingsPriorityList = SettingsPriorityList<SettingsConfig>;
