...
describe("SettingsFile", () => {
    describe("Instanciation", () => {
        it("Should load the defaults if no file is present", () => {
            const settingsFile = new settingsFile_1.SettingsFile("_test/dontSave", config);
    ...
    describe("Set", () => {
        let settingsFile;
        beforeEach(() => {
            settingsFile = new settingsFile_1.SettingsFile("_test/dontSave", config);
        });
    ...
    describe("Save", () => {
        ...
        let settingsFile;
        beforeEach(() => {
            settingsFile = new settingsFile_1.SettingsFile("_tests/save1", config);
            settingsFile.set().b.c("test");
            settingsFile.set(condition).b.c("test2");
            settingsFile.set(condition2).b.c("test3");
        });
        ...
        it("Should make new instances have the same data", () => {
            settingsFile.save();
            const settingsFile2 = new settingsFile_1.SettingsFile("_tests/save1", config);
    ...
    describe("Reload", () => {
        ...
        let settingsFile;
        beforeEach(() => {
            settingsFile = new settingsFile_1.SettingsFile("_tests/save2", config);
            settingsFile.set().b.c("test");
            settingsFile.set(condition).b.c("test2");
            settingsFile.set(condition2).b.c("test3");
            settingsFile.save();
