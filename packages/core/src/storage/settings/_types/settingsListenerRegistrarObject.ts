 ...
 */
export type SettingsListenerRegistrar<V> = (
    /**
 ...
 */
export type SettingsListenerRegistrarObject<S extends SettingsConfigSet> = {
    [P in keyof S]: S[P] extends SettingDefinition<infer V, any>
        ? SettingsListenerRegistrar<V>
        : S[P] extends SettingsConfigSet
        ? SettingsListenerRegistrarObject<S[P]>
        : S[P];
};
