 ...
 */
export type SettingsConfigSetPriorityList<C extends SettingsConfigSet> = {
 ...
 */
export type ParameterizedSettingsConfigSetPriorityList = SettingsConfigSetPriorityList<
    SettingsConfigSet
>;
