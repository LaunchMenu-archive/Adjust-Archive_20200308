 ...
 */
export type SettingsConfigPriorityList<
    C extends SettingsConfig
> = SettingsConfigSetPriorityList<C["settings"]>;

/**
 * SettingsPriorityList, but with a default parameter
 */
export type ParameterizedSettingsConfigPriorityList = SettingsConfigPriorityList<
    SettingsConfig
>;
